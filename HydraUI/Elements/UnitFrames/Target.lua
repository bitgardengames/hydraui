...
HydraUI:GetModule("GUI"):AddWidgets(Language["General"], Language["Target"], Language["Unit Frames"], function(left, right)
	...
	left:CreateSlider("unitframes-target-width", Settings["unitframes-target-width"], 120, 320, 1, Language["Width"], Language["Set the width of the unit frame"], UpdateTargetWidth)
	...
	left:CreateSlider("unitframes-target-health-height", Settings["unitframes-target-health-height"], 6, 60, 1, Language["Health Height"], Language["Set the height of the health bar"], UpdateTargetHealthHeight)
	...
	left:CreateSlider("TargetBuffSpacing", Settings.TargetBuffSpacing, -1, 4, 1, Language["Set Spacing"], Language["Set the spacing between the auras"], UpdateBuffSpacing)
	...
	left:CreateSlider("TargetDebuffSpacing", Settings.TargetDebuffSpacing, -1, 4, 1, Language["Set Spacing"], Language["Set the spacing between the auras"], UpdateDebuffSpacing)
	...
	right:CreateSlider("unitframes-target-power-height", Settings["unitframes-target-power-height"], 2, 30, 1, Language["Power Height"], Language["Set the height of the power bar"], UpdateTargetPowerHeight)
