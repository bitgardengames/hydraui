...
HydraUI:GetModule("GUI"):AddWidgets(Language["General"], Language["Pet"], Language["Unit Frames"], function(left, right)
	...
	left:CreateSlider("unitframes-pet-width", Settings["unitframes-pet-width"], 60, 320, 1, Language["Width"], Language["Set the width of the unit frame"], UpdatePetWidth)
	...
	left:CreateSlider("unitframes-pet-health-height", Settings["unitframes-pet-health-height"], 6, 60, 1, Language["Health Height"], Language["Set the height of the health bar"], UpdatePetHealthHeight)
	...
	right:CreateSlider("unitframes-pet-power-height", Settings["unitframes-pet-power-height"], 1, 30, 1, Language["Power Height"], Language["Set the height of the power bar"], UpdatePetPowerHeight)
	...
	right:CreateSlider("unitframes-pet-buff-size", Settings["unitframes-pet-buff-size"], 10, 40, 1, Language["Set Size"], Language["Set the size of the auras"], UpdateBuffSize)
	...
	right:CreateSlider("unitframes-pet-debuff-size", Settings["unitframes-pet-debuff-size"], 10, 40, 1, Language["Set Size"], Language["Set the size of the auras"], UpdateDebuffSize)
