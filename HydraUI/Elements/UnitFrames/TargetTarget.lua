...
HydraUI:GetModule("GUI"):AddWidgets(Language["General"], Language["Target of Target"], Language["Unit Frames"], function(left, right)
	...
	left:CreateSlider("unitframes-targettarget-width", Settings["unitframes-targettarget-width"], 60, 320, 1, Language["Width"], Language["Set the width of the unit frame"], UpdateTargetTargetWidth)
	...
	left:CreateSlider("unitframes-targettarget-health-height", Settings["unitframes-targettarget-health-height"], 6, 60, 1, Language["Health Height"], Language["Set the height of the health bar"], UpdateTargetTargetHealthHeight)
	...
	right:CreateSlider("unitframes-targettarget-power-height", Settings["unitframes-targettarget-power-height"], 1, 30, 1, Language["Power Height"], Language["Set the height of the power bar"], UpdateTargetTargetPowerHeight)
	...
	right:CreateSlider("unitframes-targettarget-debuff-size", Settings["unitframes-targettarget-debuff-size"], 10, 40, 1, Language["Set Size"], Language["Set the size of the auras"], UpdateDebuffSize)
