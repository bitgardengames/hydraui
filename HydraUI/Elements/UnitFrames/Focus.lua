...
HydraUI:GetModule("GUI"):AddWidgets(Language["General"], Language["Focus"], Language["Unit Frames"], function(left, right)
	...
	left:CreateSlider("unitframes-focus-width", Settings["unitframes-focus-width"], 60, 320, 1, Language["Width"], Language["Set the width of the unit frame"], UpdateFocusWidth)
	...
	left:CreateSlider("unitframes-focus-health-height", Settings["unitframes-focus-health-height"], 6, 60, 1, Language["Health Height"], Language["Set the height of the health bar"], UpdateFocusHealthHeight)
	...
	right:CreateSlider("unitframes-focus-power-height", Settings["unitframes-focus-power-height"], 1, 30, 1, Language["Power Height"], Language["Set the height of the power bar"], UpdateFocusPowerHeight)
